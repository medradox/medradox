...
def heatmap():
    ...
    palette=['#1a211d','#45452c','#776335','#aa8741','#dfb766']
    body=text(26,32,'medradox@github ~ $ ./contributions.sh',16,'#dfb766')
...
def identity():
    ...
    ramp=" .`:-=+*cs#%@"
    body=text(20,30,'medradox ~ $ whoami',13,'#dfb766')
    ...
    body+=text(20,364,'ANDRÉ MEDRADO',16,'#dfb766')
    ...
    rows=[('medradox@github','#dfb766',21),('────────────────────────────────','#30363d',14),('Analista de Dados & BI','#ffffff',18),('Logística · Transporte · Supply Chain','#8b949e',13),('','#c9d1d9',14),('Stack   Power BI / DAX / SQL Server','#c9d1d9',14),('        Python / Pandas / Power Query','#c9d1d9',14),('Base    Engenharia de Produção','#c9d1d9',14),('Foco    Dados que orientam a operação','#c9d1d9',14),('','#c9d1d9',14),('-87%    Tempo de espera de descarga','#dfb766',14),('1.600   Veículos monitorados','#dfb766',14),('-15%    Custo de transporte','#dfb766',14),('6       Dashboards em produção','#dfb766',14)]
    body=''
